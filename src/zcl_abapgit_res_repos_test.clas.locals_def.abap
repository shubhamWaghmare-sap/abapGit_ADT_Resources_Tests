...
INTERFACE lif_abapgit_provider.
  METHODS:
    ...
    perform_import IMPORTING is_request_data TYPE zcl_abapgit_res_repos_test=>ty_request_data
                             ii_log          TYPE REF TO if_abapgit_log
                   RAISING   cx_abapgit_exception,
    link_repo IMPORTING is_request_data TYPE zcl_abapgit_res_repos_test=>ty_request_data
              RAISING   cx_abapgit_exception.
ENDINTERFACE.
...
CLASS zcl_abapgit_res_repos_test DEFINITION LOCAL FRIENDS ltcl_abapgit_repos_resource.
